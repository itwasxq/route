...
dependencies {
 ...
 else if (mcData.isFabric && project.name == "26.1.2-fabric") {
        modImplementation("net.fabricmc.fabric-api:fabric-api:0.152.1+26.1.2")

        // YACL/ModMenu may need one more iteration if their 26.1.2 artifacts changed.
        modImplementation("dev.isxander:yet-another-config-lib:3.8.1+1.21.11-fabric")
